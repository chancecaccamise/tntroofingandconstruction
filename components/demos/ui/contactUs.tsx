        ...
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Looking for a trusted roofing contractor in North Carolina? Whether you need a roof replacement, storm damage repairs, gutter installation, or siding solutions — our licensed and insured team is ready to help.
              <br /><br />
              Contact us today for a free estimate and let&apos;s protect what matters most: your home.
            </p>
            <dl className="mt-10 space-y-4 text-base text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="tel:+19194381132" className="hover:text-blue-500">
                    +1 (919) 438-1132
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:tntroofingandconstruction@gmail.com" className="hover:text-blue-500">
                    tntroofingandconstruction@gmail.com
                  </a>
                </dd>
              </div>
            </dl>
