  ...
  return (
    <div id="contact" className="relative isolate bg-gray-50 pt-36 pb-20 scroll-mt-36 min-h-screen">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        {/* Left Column: Gutter-focused paragraph */}
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Schedule Your Free Gutter Estimate
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              Whether you’re dealing with clogged gutters, leaks, sagging sections, or just need a full system upgrade, our expert team is here to help. We provide gutter installations, repairs, routine maintenance, and guard systems for homes throughout Raleigh, Garner, and surrounding North Carolina communities.
              <br /><br />
              Use the form below to request your free consultation. A gutter specialist will follow up shortly to learn more about your project and recommend the best options to protect your home from water damage year-round.
            </p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <select id="service" name="service" required className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 outline-gray-300 focus:outline-blue-400">
                  ...
                  <option value="gutter-guards">Gutter Guard Installation</option>
                </select>
              </div>
